<template>
    <div id="father">
        ...
        <div id="infoChild">
            <input class="inputStyle" disabled value="Title">
            <input class="inputStyle" disabled value="Link">
            <textarea class="inputStyle pa2 " name="message" rows="6"  disabled value="Description"></textarea>
        </div>
