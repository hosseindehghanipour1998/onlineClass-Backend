...
class RoomCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Room
        fields = ['id', 'name', 'link', 'admin' ,'description']
        '''
        extra_kwargs = {
            "link": {"read_only": True}
        }
...
class RoomRetrieveSerializer(serializers.ModelSerializer):
    class Meta:
        model = Room
        fields = ['id', 'name', 'link', 'admin', 'participate','description']
...
class ExamSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'title','room', 'questions']
...
class RetrieveExamQuestions(serializers.ModelSerializer):
    class Meta:
        model = Question
        fields = '__all__'
